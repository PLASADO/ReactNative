...
export default class ModalDropdown extends Component {
  ...
  _renderButton() {
    ...
    console.log("value1:" + this.state.showDropdown);
      ...
      >
        {
          ...
          (
            <View style={styles.button}>
              <Text style={[styles.buttonText, textStyle, {flex: 1, marginRight: 3}]}
                    numberOfLines={1}
              >
                {buttonText}
              </Text>
              <Image source={ (!this.state.showDropdown) ? require('../resources/ic_arrow_down.png') : require('../resources/ic_arrow_up.png') } style={{width: 12, height: 8, marginRight: 15}}/>
            </View>
          )
        }
      </TouchableOpacity>
